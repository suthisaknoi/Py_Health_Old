...
from resizeimage import resizeimage                  ## python-resize-image
from PIL import Image                                ## pillow
# from xlwt import Workbook
# เรียกใช้ module ที่มาจาก pyscard สำหรับดึงข้อมูลจากบัตร
from smartcard.System import readers                 ## ดูการติดตั้ง ที่  https://medium.com/@psk_dream/%E0%B9%80%E0%B8%82%E0%B8%B5%E0%B8%A2%E0%B8%99-python-3-%E0%B8%95%E0%B8%B4%E0%B8%94%E0%B8%95%E0%B9%88%E0%B8%AD%E0%B8%81%E0%B8%B1%E0%B8%9A%E0%B9%80%E0%B8%84%E0%B8%A3%E0%B8%B7%E0%B9%88%E0%B8%AD%E0%B8%87%E0%B8%AD%E0%B9%88%E0%B8%B2%E0%B8%99%E0%B8%9A%E0%B8%B1%E0%B8%95%E0%B8%A3-%E0%B8%9B%E0%B8%A3%E0%B8%B0%E0%B8%8A%E0%B8%B2%E0%B8%8A%E0%B8%99-c9ef4980733a
...
tis620encoding = {
    ...
    45: '-', 46: '.',
    47: '/', 48: '0', 49: '1', 50: '2', 51: '3', 52: '4', 53: '5', 54: '6', 55: '7', 56: '8', 57: '9', 58: ':', 59: ';',
    60: '<', 61: '=',
    62: '>', 63: '?', 64: '@', 65: 'A', 66: 'B', 67: 'C', 68: 'D', 69: 'E', 70: 'F', 71: 'G', 72: 'H', 73: 'I', 74: 'J',
    75: 'K', 76: 'L',
    ...
    168: '\u0e08', 169: '\u0e09',
    170: '\u0e0a', 171: '\u0e0b', 172: '\u0e0c', 173: '\u0e0d', 174: '\u0e0e', 175: '\u0e0f', 176: '\u0e10',
    177: '\u0e11', 178: '\u0e12',
    179: '\u0e13', 180: '\u0e14', 181: '\u0e15', 182: '\u0e16', 183: '\u0e17', 184: '\u0e18', 185: '\u0e19',
    186: '\u0e1a', 187: '\u0e1b',
    188: '\u0e1c', 189: '\u0e1d', 190: '\u0e1e', 191: '\u0e1f', 192: '\u0e20', 193: '\u0e21', 194: '\u0e22',
    195: '\u0e23', 196: '\u0e24',
    197: '\u0e25', 198: '\u0e26', 199: '\u0e27', 200: '\u0e28', 201: '\u0e29', 202: '\u0e2a', 203: '\u0e2b',
    204: '\u0e2c', 205: '\u0e2d',
    206: '\u0e2e', 207: '\u0e2f', 208: '\u0e30', 209: '\u0e31', 210: '\u0e32', 211: '\u0e33', 212: '\u0e34',
    213: '\u0e35', 214: '\u0e36',
    215: '\u0e37', 216: '\u0e38', 217: '\u0e39', 218: '\u0e3a',

    223: '\u0e3f', 224: '\u0e40', 225: '\u0e41', 226: '\u0e42', 227: '\u0e43', 228: '\u0e44', 229: '\u0e45',
    230: '\u0e46', 231: '\u0e47',
    232: '\u0e48', 233: '\u0e49', 234: '\u0e4a', 235: '\u0e4b', 236: '\u0e4c', 237: '\u0e4d', 238: '\u0e4e',
    239: '\u0e4f', 240: '\u0e50',
...
try:
    ...
    CMD_ADDRESS = [0x80, 0xB0, 0x15, 0x79, 0x02, 0x00, 0x64]  # Address CMD_ADDRESS = [0x80, 0xb0, 0x15, 0x79, 0x02, 0x00, 0x64]
...
def textCard():  # ข้อมูลในบัตรทั้งหมด ยกเว้นรูป
    try:
        ...
        monthThai = ['null', 'มกราคม', 'กุมภาพันธ์', 'มีนาคม', 'เมษายน', 'พฤษภาคม', 'มิถุนายน', 'กรกฎาคม', 'สิงหาคม',
                     'กันยายน', 'ตุลาคม', 'พฤศจิกายน', 'ธันวาคม']
        monthEng = ['null', 'January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September',
        ...
        count.append(thai2unicode(data[0]))     #----------3
        ...
        count.append(Card_Is)                   #----------6
        # print("สถานที่ออกบัตร: " + Card_Is)

        # Issue Date
        data = getData(CMD_ISSUE, req)
        count.append(thai2unicode(data[0]))     #----------7
        ...
        count.append(Issue_Date)                #----------8
        # print("วันออกบัตร: " + Issue_Date)

        # Expire Date
        data = getData(CMD_EXPIRE, req)
        count.append(thai2unicode(data[0]))     #----------9
